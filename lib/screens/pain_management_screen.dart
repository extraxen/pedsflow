...
class PainManagementScreen extends StatelessWidget {
  ...
  static const List<_PainTopic> topics = <_PainTopic>[
    _PainTopic('Mild pain', Icons.sentiment_satisfied_outlined, <_PainSection>[
      ...
      _PainSection('Initial treatment', <String>['Comfort positioning, explanation, distraction, heat/ice when appropriate and caregiver involvement.','Acetaminophen 10â€“15 mg/kg PO every 4â€“6 hours as needed; do not exceed the lower of 75 mg/kg/day or the institutional maximum.','Ibuprofen 10 mg/kg PO every 6â€“8 hours as needed (usual maximum 400 mg/dose); avoid with significant dehydration, renal impairment, GI bleeding or NSAID contraindication.']),
      _PainSection('Reassessment', <String>['Reassess pain and function within 30â€“60 minutes after oral medication and after any clinical change.','Escalate if pain remains moderate/severe, diagnosis is uncertain, or red flags are present.']),
    ]),
    _PainTopic('Moderate pain', Icons.healing_outlined, <_PainSection>[
      ...
      _PainSection('Medication options', <String>['Fentanyl intranasal 1â€“2 micrograms/kg (usual maximum 100 micrograms total), divided between nostrils; monitor sedation and respiration.','Morphine PO 0.2â€“0.5 mg/kg every 4â€“6 hours (usual maximum 15 mg/dose), starting at the lower end in opioid-naive patients.','Ketorolac 0.5 mg/kg IV every 6â€“8 hours may be used when appropriate; use local age/dose maximums and avoid renal/GI bleeding risk.']),
    ...
    _PainTopic('Severe pain', Icons.warning_amber_outlined, <_PainSection>[
      ...
      _PainSection('Parenteral options', <String>['Morphine IV 0.05â€“0.1 mg/kg slowly; reassess and titrate using local maximums and opioid-naive precautions.','Fentanyl IV 0.5â€“1 microgram/kg slowly may be preferred when rapid titration or less histamine release is desired.','Consider PCA or nurse-controlled analgesia with a standardized institutional protocol for ongoing severe pain.']),
    ...
    _PainTopic('Sickle-cell vaso-occlusive pain', Icons.bloodtype_outlined, <_PainSection>[
      _PainSection('First hour', <String>['Assess promptly and initiate analgesia within 30â€“60 minutes. Exclude acute chest syndrome, infection, sequestration, osteomyelitis, avascular necrosis and other causes.','Give intranasal fentanyl 1â€“2 micrograms/kg (maximum 100 micrograms) when appropriate, followed by oral or IV opioid according to response.']),
      _PainSection('Ongoing treatment', <String>['Schedule acetaminophen and one NSAID when not contraindicated; do not combine oral and IV NSAIDs.','Morphine PO 0.2â€“0.5 mg/kg every 4â€“6 hours or IV 0.1 mg/kg slowly with reassessment; use patient-specific plans and local maxima.','Use maintenanceâ€”not hyperhydrationâ€”when IV fluids are needed; encourage oral intake, mobility, heat, incentive spirometry and bowel prophylaxis.']),
    ...
    _PainTopic('Post-operative pain', Icons.medical_services_outlined, <_PainSection>[
      _PainSection('Multimodal plan', <String>['Use scheduled acetaminophen and NSAID when permitted by the procedure and patient factors.','Use regional/local anesthetic techniques and non-pharmacologic measures when available.','Reserve opioids for breakthrough moderateâ€“severe pain and use the lowest effective dose.']),
    ...
    _PainTopic('Opioid monitoring', Icons.monitor_heart_outlined, <_PainSection>[
      ...
      _PainSection('After dosing', <String>['Reassess after IV dosing within minutes and after oral dosing within the expected onset window.','Use continuous pulse oximetry for high-risk children or repeated/parenteral dosing; capnography may be useful when deeply sedated or receiving PCA.','Sedation usually precedes respiratory arrestâ€”hold opioid and escalate for increasing somnolence, snoring/obstruction, bradypnea or desaturation.']),
    ]),
    ...
    _PainTopic('Opioid conversion', Icons.swap_horiz_outlined, <_PainSection>[
      _PainSection('Safety principles', <String>['Equianalgesic tables are estimates and vary by age, route, opioid exposure and clinical state.','Calculate the total opioid dose over the previous 24 hours, convert using an institutional pediatric table, then reduce the calculated new opioid dose for incomplete cross-toleranceâ€”often by 25â€“50%â€”unless pain severity requires specialist adjustment.']),
